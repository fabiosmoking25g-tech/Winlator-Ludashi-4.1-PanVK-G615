...
private val advancedEnvSpecs = mapOf(
    ...
    "PAN_I_WANT_A_BROKEN_VULKAN_DRIVER" to AdvancedEnvSpec(AdvancedEnvKind.CHECKBOX, listOf("0", "1")),
    "PANVK_DEBUG" to AdvancedEnvSpec(AdvancedEnvKind.MULTI, listOf("startup", "nir", "trace", "sync", "cs", "dump")),
    "PANVK_KBASE_DVFS" to AdvancedEnvSpec(AdvancedEnvKind.TEXT)
)
