...
val knownEnvironmentVariables = listOf(
    ...
    EnvVariableSpec("PAN_I_WANT_A_BROKEN_VULKAN_DRIVER", EnvValueKind.CHECKBOX, listOf("0", "1")),
    EnvVariableSpec("PANVK_DEBUG", EnvValueKind.MULTI, listOf("startup", "nir", "trace", "sync", "cs", "dump")),
    EnvVariableSpec("PANVK_KBASE_DVFS", EnvValueKind.TEXT)
)
